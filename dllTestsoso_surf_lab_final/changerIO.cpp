...
{   
   ...
   // cout<<"findHomography start"<<endl;
   //  cout<<"m_LeftInlier size="<<m_LeftInlier.size()<<endl;
   //   cout<<"m_RightInlier size="<<m_RightInlier.size()<<endl;
    ...
    cout<<"proheight="<<proheight<<endl;
     ...
     if(proheight<0||prowidth<0||abs(start1)>1080||abs(start2)>1080||proheight>10||prowidth>1920)
    {
       Hflag=0;
