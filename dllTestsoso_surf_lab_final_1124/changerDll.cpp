...
//cout<<"save cf_bw_gray ok"<<endl;
   ChangeDetector(rImgA[0],rImgB[0],params,output,outputCorrelationCf,"/home/tuxiang/liquan/Pictures/DebugResult/cf_bw_L.jpg");
//cout<<"save cf_bw_L ok"<<endl;
   ChangeDetector(rImgA[1],rImgB[1],params,output,outputCorrelationCf,"/home/tuxiang/liquan/Pictures/DebugResult/cf_bw_a.jpg");
//cout<<"save cf_bw_a ok"<<endl;
   ChangeDetector(rImgA[2],rImgB[2],params,output,outputCorrelationCf,"/home/tuxiang/liquan/Pictures/DebugResult/cf_bw_b.jpg");
